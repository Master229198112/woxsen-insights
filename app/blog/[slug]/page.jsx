...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      ...
      url: `${process.env.NEXTAUTH_URL || 'http://localhost:3000'}/blog/${blog.slug}`
    },
    twitter: {
    ...
    alternates: {
      canonical: `${process.env.NEXTAUTH_URL || 'http://localhost:3000'}/blog/${blog.slug}`
    }
  };
}
