                ...
                <div className="flex items-center space-x-2 flex-shrink-0">
                  ...
                  >
                    ...
                    <div className="text-sm min-w-0 flex-1 hidden lg:block">
                      <div className="font-medium text-gray-900 truncate max-w-32 hover:text-blue-600 transition-colors">
                        {session.user.name}
                      </div>
              ...
              {session ? (
                <div className="border-t border-gray-200 pt-2 mt-2 space-y-1">
                  ...
                  >
                    ...
                    <div>
                      <div className="text-sm font-medium text-gray-900 hover:text-blue-600">{session.user.name}</div>
